...
var __SoundEngine = function () {
    ...
    if (cc.sys.isNative) {
        ...
        this.effectVolume = parseInt(effectValue) / 100;
        this.musicVolume = parseInt(musicValue) / 100;


        this.setEffectsVolume = function (effectVolume) {
            cc.sys.localStorage.setItem("effectValue",effectVolume * 100)
        ...
        this.setBackgroundMusicVolume = function (musicVolume) {
            ...
            cc.sys.localStorage.setItem("musicValue",musicVolume * 100)
        ...
        this.playEffect = function (soundPath, isLoop, volume, audioProfile) {
            ...
            if (!effectValue) effectValue = '50';
            this.effectVolume = parseInt(effectValue) / 100;
            var volume = this.effectVolume;
            console.log("音效音量" + volume);
        ...
        this.playBackgroundMusic = function (soundPath, isLoop, volume, audioProfile) {
            ...
            return this.backgroundMusicID = audioEngine.play2d(soundPath, isLoop, this.musicVolume);
