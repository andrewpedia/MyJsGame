...
var ToastSystem = function (parent, zorder) {
    ...
    self.work = function () {
        ...
        if (config.bg) {
            ...
            var bg = new ccui.Scale9Sprite("hall_common_tip_bg.png");
            // bg.initWithSpriteFrameName("res/img/gui-wz-ts-bj.png");
            bg.size(textSize.width + 100, textSize.height + 20);
            bg.to(toastContainer).pp();

            // if (!cc.spriteFrameCache.getSpriteFrame("res/img/gui-wz-ts-bj.png")) {
            //     var textSize = text.getContentSize();
            //     var layerGradient;
            //     if (cc.sys.isNative) {
